...
// 앱은 경로로 두 영역을 구분한다.
//   - 점주/운영자(POS) 영역: "/", "/login", "/store/:storeId", "/operator*"
//   - 고객용 QR 주문 영역: "/order"(테이블), "/pickup"(포장) — QR URL 스킴은 GEARING.md 참고
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* 고객용 QR 주문 */}
        <Route path="/order" element={<StoreZone />} />
        <Route path="/pickup" element={<StoreZone />} />
